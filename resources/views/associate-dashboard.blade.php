						...
						<div class="card radius-15 w-100">
							<div class="card-body">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{url('public/assets/images/icons/chrome.png')}}" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{url('public/assets/images/icons/firefox.png')}}" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{url('public/assets/images/icons/edge.png')}}" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{url('public/assets/images/icons/opera.png')}}" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{url('public/assets/images/icons/safari.png')}}" width="35" height="35" alt="" />
									</div>
									<div class="">
							...
							<div class="table-responsive">
								<table class="table mb-0">
									...
									<tbody>
										<tr>
											<td>1</td>
											<td><a href="https://www.templatemonster.com/admin-templates/rocker-bootstrap-5-admin-dashboard-template-179723.html">Syndron - Bootstrap5 Admin Template</a>
											</td>
											<td>660</td>
											<td>55s</td>
											<td>3.6%</td>
										...
										<tr>
											<td>2</td>
											<td><a href="https://www.templatemonster.com/admin-templates/skodash-bootstrap-5-admin-template-235948.html">Skodash - Bootstrap 5 Admin Template</a>
											</td>
											<td>352</td>
											<td>16s</td>
											<td>8.4%</td>
										...
										<tr>
											<td>3</td>
											<td><a href="https://www.templatemonster.com/admin-templates/dashtreme-multipurpose-bootstrap5-admin-template-187133.html">Dashtreme - Multipurpose Bootstrap5 Admin Template</a>
											</td>
											<td>101</td>
											<td>10s</td>
											<td>6.7%</td>
										...
										<tr>
											<td>4</td>
											<td><a href="https://www.templatemonster.com/admin-templates/rukada-responsive-bootstrap-5-admin-template-184125.html">Rukada - Responsive Bootstrap 5 Admin Template</a>
											</td>
											<td>95</td>
											<td>57s</td>
											<td>5.2%</td>
										...
										<tr>
											<td>5</td>
											<td><a href="https://www.templatemonster.com/admin-templates/dashtrans-bootstrap5-admin-template-183385.html">Dashtrans - Bootstrap5 Admin Template</a>
											</td>
											<td>102</td>
											<td>45s</td>
											<td>7.2%</td>
