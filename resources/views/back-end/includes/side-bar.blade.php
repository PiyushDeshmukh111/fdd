<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div class="">
					<img src="{{asset('public/assets/images/logo-icon.png')}}" class="logo-icon-2" alt="" />
				</div>
				<div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="authentication-login.html"><i class="bx bx-right-arrow-alt"></i>Login</a>
						</li>
						<li> <a href="authentication-register.html"><i class="bx bx-right-arrow-alt"></i>Register</a>
						</li>
